...
def create_playfair_matrix(key: str) -> list:
    """
    Create a Playfair cipher matrix from a key.
    
    Args:
        key (str): The key to create the matrix from
        
    Returns:
        list: A 5x5 matrix for the Playfair cipher
    """
    cipher = PlayFairCipher()
    return cipher.create_playfair_matrix(key)
...
def playfair_encrypt(text: str, key: str) -> str:
    ...
    return cipher.playfair_encrypt(text, matrix)
...
def playfair_decrypt(text: str, key: str) -> str:
    ...
    cipher = PlayFairCipher()
    matrix = cipher.create_playfair_matrix(key)
    return cipher.playfair_decrypt(text, matrix)